...
public class MoveCommandTB : Control
{
    ...
    public void PlotRotation()
    {
        ...
        try
        {
            ...
            velPlot.SetGrid(period/(testState.Preview.Count() - 1f), Mathf.Pi/4f, xrange, yrange);
            ...
            posPlot.SetGrid(period/(testState.Preview.Count() - 1f), Mathf.Pi/4f, xrange, yrange);
